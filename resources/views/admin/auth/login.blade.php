...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('AdminLTE-2.3.7/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <a href="#">忘记密码</a><br>
        <a href="{{ route('admin.auth.register') }}" class="text-center">注册新账号</a>
...
<!-- iCheck -->
<script src="{{ asset('AdminLTE-2.3.7/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
